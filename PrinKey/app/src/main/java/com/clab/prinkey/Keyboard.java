...
final class Keyboard {
    ...
    private final PrinKeyService mPrinKeyService;
    ...
    private Keyboard(PrinKeyService prinKeyService, int viewResId,
                     SparseArray<String> keyMapping) {
        this.mPrinKeyService = prinKeyService;
...
//        createKeyIdArray();
    ...
    static Keyboard prinkey(PrinKeyService prinKeyService) {
        ...
        return new Keyboard(prinKeyService, R.layout.keyboard_prinkey, keyMapping);
    }

    static Keyboard prinkey_num(PrinKeyService prinKeyService) {
        SparseArray<String> keyMapping = new SparseArray<>();
        keyMapping.put(R.id.key_pos_wave_mark, "~");
        keyMapping.put(R.id.key_pos_0_1, "bB+`");
        keyMapping.put(R.id.key_pos_0_2, "cC×\\");
        ...
        return new Keyboard(prinKeyService, R.layout.keyboard_prinkey_num, keyMapping);
    }
    ...
    private void handleTouchDown(String data, int index) {
        if (mDataBaseHelper.getSettingValue(mCustomVariables.SETTINGS_USE_VIBRATION_FEEDBACK)) {
            mPrinKeyService.getVibratorService().vibrate(
        ...
        mPrinKeyService.handleTouchDown(getTextFromFuncKey(data));
    }
    ...
    private void handleGestureInput(String data) {
        ...
        mPrinKeyService.handleTouchDown(
    ...
    void initializeDataBaseHelper() {
        mDataBaseHelper = mPrinKeyService.getDataBaseHelper();
    }
    ...
    private int dpToPx(float dp) {
        float density = mPrinKeyService.getResources().getDisplayMetrics().density;
    ...
    private void continueInputHandler() {
        ...
        mPrinKeyService.handleTouchDown(getTextFromFuncKey(mCurrentClickedKey));
    }
